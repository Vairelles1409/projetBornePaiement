...
o	Si vous avez un mot de passe MySQL, modifiez la ligne :
<property name="connection.password">VOTRE_MDP</property>
o	Sinon, laissez-le vide.
...
o	Note sur l'héritage : Nous utilisons la stratégie JOINED. Les données communes sont dans personnes, et les données spécifiques dans administrateurs, cuisiniers ou clients.
